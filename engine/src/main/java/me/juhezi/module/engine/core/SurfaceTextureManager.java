...
public class SurfaceTextureManager
    ...
    private Function1<String, Unit> log = FunctionsKt.log(TAG, LOG);    //调用 Kotlin 中的函数
    ...
    public SurfaceTextureManager() {
        ...
        log.invoke("textureID = " + mTextureRender.getTextureId());
    ...
    public void onFrameAvailable(SurfaceTexture surfaceTexture) {
        log.invoke("new frame available");
        synchronized (mFrameSynObject) {
            if (mFrameAvailable) {
